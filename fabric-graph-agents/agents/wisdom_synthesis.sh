...
EOF
    ...
    cat "$temp_input" | fabric-ai -p extract_wisdom > "$RUN_DIR/output/node-1.md" 2>&1 || {
    ...
    cat "$RUN_DIR/output/node-1.md" | fabric-ai -p extract_insights > "$RUN_DIR/output/node-2.md" 2>&1 || {
    ...
    cat "$RUN_DIR/output/node-2.md" | fabric-ai -p extract_recommendations > "$RUN_DIR/output/node-3.md" 2>&1 || {
    ...
    cat "$RUN_DIR/output/node-3.md" | fabric-ai -p improve_prompt > "$RUN_DIR/output/node-4.md" 2>&1 || {
